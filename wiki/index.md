...
- [[NEXUS v2 Gap Cycle]] — **the fmed verdict**: close the three safety loops first, defer breadth; v1.1.0 shipped, all tests green.
...
- [[NEXUS Clinical Platform]] — the fmed clinical platform; v1 safety spine + v1.1 safety loops.
