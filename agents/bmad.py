...
BMAD_ROLES = {
    ...
    "investigator": {
        "title": "OpenPlanter Investigator",
        "mandate": "Ingest datasets, resolve entities, cross-reference sources, and surface non-obvious connections via recursive analysis (OpenPlanter).",
    },
}
